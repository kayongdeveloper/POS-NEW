    ...
    <>
      <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
        ...
        <div className="flex flex-col items-center gap-6 xl:flex-row xl:items-center xl:justify-between">
          ...
          {/* Avatar + Info + Socials */}
          <div className="flex flex-col items-center gap-5 w-full xl:flex-row">

            {/* Avatar */}
            <div className="relative flex-shrink-0">
              <div className="w-20 h-20 overflow-hidden rounded-full ring-4 ring-brand-500/10 border border-gray-200 dark:border-gray-700">
                <Image
                  width={80}
                  height={80}
              ...
              {/* Online badge */}
              <span className="absolute bottom-0.5 right-0.5 block w-4 h-4 rounded-full bg-green-500 ring-2 ring-white dark:ring-gray-900" />
            </div>
            ...
            <div className="flex flex-col items-center xl:items-start gap-1 xl:flex-1">
              ...
              <div className="flex items-center gap-2 mt-2">
                <a target="_blank" rel="noreferrer" href="https://www.facebook.com/PimjoHQ"
                  className="flex h-8 w-8 items-center justify-center rounded-lg border border-gray-200 bg-white text-gray-500 transition-colors hover:border-brand-300 hover:bg-brand-50 hover:text-brand-500 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-brand-500/10 dark:hover:text-brand-400"
                >
                ...
                <a href="https://x.com/PimjoHQ" target="_blank" rel="noreferrer"
                  className="flex h-8 w-8 items-center justify-center rounded-lg border border-gray-200 bg-white text-gray-500 transition-colors hover:border-brand-300 hover:bg-brand-50 hover:text-brand-500 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-brand-500/10 dark:hover:text-brand-400"
                >
                  <svg className="fill-current" width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="https://www.linkedin.com/company/pimjo" target="_blank" rel="noreferrer"
                  className="flex h-8 w-8 items-center justify-center rounded-lg border border-gray-200 bg-white text-gray-500 transition-colors hover:border-brand-300 hover:bg-brand-50 hover:text-brand-500 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-brand-500/10 dark:hover:text-brand-400"
                >
                  <svg className="fill-current" width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="https://instagram.com/PimjoHQ" target="_blank" rel="noreferrer"
                  className="flex h-8 w-8 items-center justify-center rounded-lg border border-gray-200 bg-white text-gray-500 transition-colors hover:border-brand-300 hover:bg-brand-50 hover:text-brand-500 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-brand-500/10 dark:hover:text-brand-400"
                >
                  <svg className="fill-current" width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <Modal isOpen={isOpen} onClose={closeModal} className="max-w-[600px] m-4">
        <div className="no-scrollbar relative w-full overflow-y-auto rounded-3xl bg-white dark:bg-gray-900">

          {/* Modal Header */}
          <div className="flex items-center gap-3 px-6 py-5 border-b border-gray-100 dark:border-gray-800">
            <div className="w-10 h-10 overflow-hidden rounded-full ring-2 ring-brand-500/20 flex-shrink-0">
              <Image width={40} height={40} src="/images/user/owner.jpg" alt="user" className="object-cover w-full h-full" />
            </div>
            <div>
          ...
          <form className="flex flex-col">
            <div className="px-6 py-5 flex flex-col gap-6 overflow-y-auto max-h-[60vh] custom-scrollbar">

              {/* Personal Information */}
              <div>
                <h5 className="text-xs font-semibold uppercase tracking-wider text-gray-400 dark:text-gray-500 mb-4">
                  Personal Information
                </h5>
