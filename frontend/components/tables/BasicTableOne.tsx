    ...
    <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-white/[0.05] dark:bg-white/[0.03]">
        ...
        <div className="min-w-[700px]">
          <Table>
            <TableHeader className="border-b border-gray-100 dark:border-white/[0.05] bg-gray-50/50 dark:bg-white/[0.02]">
              <TableRow>
                <TableCell isHeader className="px-5 py-3 text-xs font-semibold uppercase tracking-wider text-gray-400 dark:text-gray-500 text-start">
                  User
                </TableCell>
                <TableCell isHeader className="px-5 py-3 text-xs font-semibold uppercase tracking-wider text-gray-400 dark:text-gray-500 text-start">
                  Username
                ...
                >
                  ...
                  <TableCell className="px-5 py-3.5 text-start">
                    <span className="inline-flex items-center gap-1.5 text-sm text-gray-500 dark:text-gray-400">
                      <svg className="fill-gray-300 dark:fill-gray-600" width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fillRule="evenodd" clipRule="evenodd" d="M4 4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2H4zm0 2h16v2.586l-8 8-8-8V6zm0 4.828 7.293 7.293a1 1 0 0 0 1.414 0L20 10.828V18H4v-7.172z" fill=""/>
                      </svg>
                      @{user.username}
                    </span>
                  </TableCell>
                  ...
                  {/* Role */}
                  <TableCell className="px-5 py-3.5 text-start">
                    <span className={`inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-medium ${roleBadgeStyle(user.role)}`}>
                      {user.role}
                    </span>
                  </TableCell>
                  ...
                  <TableCell className="px-5 py-3.5 text-start">
                    <div className="flex items-center gap-2">
                      ...
                      <button className="flex items-center justify-center w-8 h-8 rounded-lg border border-gray-200 bg-white text-gray-500 transition-colors hover:border-red-300 hover:bg-red-50 hover:text-red-500 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-red-500/10 dark:hover:text-red-400">
                        <svg className="fill-current" width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path fillRule="evenodd" clipRule="evenodd" d="M9 3a1 1 0 0 0-1 1H5a1 1 0 0 0 0 2h14a1 1 0 1 0 0-2h-3a1 1 0 0 0-1-1H9zM6 7a1 1 0 0 1 1 1v10a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V8a1 1 0 1 1 2 0v10a3 3 0 0 1-3 3H8a3 3 0 0 1-3-3V8a1 1 0 0 1 1-1zm3 2a1 1 0 0 1 1 1v6a1 1 0 1 1-2 0v-6a1 1 0 0 1 1-1zm4 0a1 1 0 0 1 1 1v6a1 1 0 1 1-2 0v-6a1 1 0 0 1 1-1z" fill=""/>
                        </svg>
                      </button>
                    </div>
                  </TableCell>
      ...
      <div className="flex items-center justify-between px-5 py-3.5 border-t border-gray-100 dark:border-white/[0.05]">
        ...
        <div className="flex items-center gap-1">
          <button className="flex items-center justify-center w-7 h-7 rounded-lg border border-gray-200 text-gray-400 hover:bg-gray-50 dark:border-gray-700 dark:hover:bg-white/[0.03] disabled:opacity-40" disabled>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M15 18l-6-6 6-6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </button>
          <button className="flex items-center justify-center w-7 h-7 rounded-lg bg-brand-500 text-white text-xs font-medium">1</button>
          <button className="flex items-center justify-center w-7 h-7 rounded-lg border border-gray-200 text-gray-400 hover:bg-gray-50 dark:border-gray-700 dark:hover:bg-white/[0.03] disabled:opacity-40" disabled>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
