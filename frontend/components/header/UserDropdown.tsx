...
export default function UserDropdown() {
  ...
  return (
    <div className="relative">
      ...
      >
        <div className="relative">
          <span className="block overflow-hidden rounded-full h-9 w-9 ring-2 ring-brand-500/20">
            <Image
              width={36}
              height={36}
        ...
        <svg
          className={`hidden lg:block stroke-gray-400 transition-transform duration-200 ${
            isOpen ? "rotate-180" : ""
          }`}
          width="16"
          height="16"
      ...
      >
        ...
        {/* Menu Items */}
        <ul className="flex flex-col gap-0.5 p-2 border-b border-gray-100 dark:border-gray-800">
          <li>
            <DropdownItem
              onItemClick={closeDropdown}
              tag="a"
              href="/profile"
              className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-gray-600 transition-colors hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-200 group"
            >
              <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-gray-100 group-hover:bg-brand-50 dark:bg-gray-800 dark:group-hover:bg-brand-500/10 transition-colors">
                <svg className="fill-gray-500 group-hover:fill-brand-500 transition-colors" width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="p-2">
          <Link
            href="/signin"
            className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-red-500 transition-colors hover:bg-red-50 dark:hover:bg-red-500/10 group"
          >
            <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-red-50 group-hover:bg-red-100 dark:bg-red-500/10 transition-colors">
              <svg className="fill-red-400" width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
