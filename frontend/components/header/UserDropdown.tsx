  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <svg
          className={`hidden lg:block stroke-gray-400 transition-transform duration-200 ${isOpen ? "rotate-180" : ""
            }`}
          width="16"
          height="16"
          viewBox="0 0 18 20"
      ...
      >
        ...
        <div className="p-2">
          <button
            ...
            className="flex w-full items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-red-500 transition-colors hover:bg-red-50 disabled:opacity-50 disabled:cursor-not-allowed dark:hover:bg-red-500/10 group"
          >
